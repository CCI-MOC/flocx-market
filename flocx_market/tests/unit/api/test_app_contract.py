...
contract_1_bid = models.Bid(marketplace_bid_id='test_bid_1',
                            creator_bid_id="1234",
                            creator_id="2345",
                            server_quantity=2,
                            start_time=now,
...
contract_2_bid = models.Bid(marketplace_bid_id='test_bid_2',
                            creator_bid_id="2345",
                            creator_id="3456",
                            server_quantity=2,
                            start_time=now,
...
contract_1_offer = models.Offer(marketplace_date_created=now,
...
contract_2_offer = models.Offer(marketplace_offer_id='test_offer_2',
...
test_contract_1 = models.Contract(contract_id='test_contract_1',
                                  time_created=now,
                                  status='available',
                                  start_time=now,
                                  end_time=now,
...
test_contract_2 = models.Contract(contract_id='test_contract_2',
                                  time_created=now,
                                  status='available',
                                  start_time=now,
                                  end_time=now,
...
@mock.patch('flocx_market.db.sqlalchemy.api.contract_get')
def test_update_contract(mock_get, mock_update, client):
    mock_get.return_value = test_contract_1
...
@mock.patch('flocx_market.db.sqlalchemy.api.contract_update')
@mock.patch('flocx_market.db.sqlalchemy.api.contract_get')
def test_update_contract_missing(mock_get, mock_update, client):
    mock_get.return_value = None
