...
class OfferModel(db.Model):
    ...
    def __init__(self, marketplace_offer_id, provider_id, creator_id, marketplace_date_created, status, server_id,
    ...
    def json(self):
        return {
            ...
            'marketplace_date_created': self.marketplace_date_created,
            'status': self.status,
